...
#' @param id_is_int (`logical` flag) if `TRUE`, the OTU identifiers are integers; in
#' this case they are expected to be in columns `seq_idx*`. If `FALSE`, the OTU
#' identifiers are character strings, and are expected to be in columns
#' `seq_id*`. Default: `TRUE` if `otu_table` has a column `seq_idx`, `FALSE`
#' otherwise.
...
#'
#' @param seqall_file (`character` string) name of a gzipped FASTA file
...
#' `seqall_file`, as generated by [fastx_gz_index()].
