...
#' @return the output file name
#' @export
fastq_sample <- function(infile, outfile, n, sample, rename = FALSE) {
    .Call(`_optimotu_pipeline_fastq_sample`, infile, outfile, n, sample, rename)
}
...
lulu_map_lowmem_impl <- function(otu_table_names, match_table_names, max_dist, min_abundance_ratio = 1.0, min_cooccurrence_ratio = 0.95, use_mean_abundance_ratio = FALSE, verbose = 0L) {
